...
def write_in_file(data, file_name, path):
    instruct = "A user has given high ratings to the following books. " \
               "Given the book list and a target book's title. " \
               "Please identify whether the user will like the target book by answering 'Yes.' or 'No.'"
        ...
        for uid, target, his, label in data:
            ...
            chatml_format = {
                ...
                "messages": [
                    ...
                    {"role": "user", "content": f"BookList: {his_non}, Targetbook: {target}"},
...
data_dir = "/datas/wuxi/Projects/datas/data/AmazonBook/data_5core_80w/"
path = "../data/book/"
